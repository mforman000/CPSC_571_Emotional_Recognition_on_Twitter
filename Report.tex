...
After reading through current papers that have also had intentions to create an algorithm to assign sentiment to tweets we have discovered the following.
...
Through analyzing existing papers we have created some pros and some cons with exisiting methodologies. \newline
\newline
Pros: 
\begin{itemize}
...
Cons:
\begin{itemize}
    \item Only have found one study in which unsupervised algoirthms were tested in this context.
