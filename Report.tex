...
For example this was the way tweets were separated in a study by Samah Jailani, Hamzah, Amunuddin, Abidin, and Riza in wich there algorithm "establishes whether a particulartweet is supportive, critical, or neutral\cite{b9}."
Emotion can also be assigned to tweets, these being split up into sections of anger, sadness, joy, fear, and disgust. 
In a study by Benrouba, and Boudour, IBM's natural language understanding API tool was used to analyze words associated with positive, negative and neutral emotions\cite{b8}.
...
An SVM works by indentifying "a hyperplane that distinguishably segregates the data points of differnt classes \cite{b13}." 
...
As well, with modfications this strategy has been used to not only cover binary data but through using a method called a "kernel trick\cite{b13}" it is used on multidimensional data as well. 
...
As well, in the study by Susmitha, Nikhul, Akhil, Kavitha, Reddy, and Shailaja, SVM had an accuracy percentage of 82\%\cite{b12}. 
Despite the success of this algorithm with studies seeing accuracy levels in the 90th percentile there is still a gap in knowledge on how an unsupervised algorithm would keep up.
A newer unsupervised algorithm that has burst onto the scene is BERT.\newline 
\newline
BERT
...
\bibitem{b8} \url{https://link.springer.com/article/10.1007/s13278-022-01000-9}
\bibitem{b9} \url{https://semarakilmu.com.my/journals/index.php/applied_sciences_eng_tech/article/view/3281/3455}
\bibitem{b10} \url{https://ojs.wiserpub.com/index.php/CCDS/article/view/1827}
\bibitem{b11} \url{https://link.springer.com/chapter/10.1007/978-981-19-8865-3_12}
\bibitem{b12} \url{https://ieeexplore.ieee.org/abstract/document/10084278?casa_token=GlPE_azfZjoAAAAA:Uk5ZcMsTMxXDFkBargYNGNlRHcoa9OyNy9uMpXBAo3gc70oD59nl6fnJw4J_Bts1-pUa8mO_}
\bibitem{b13} \url{https://www.spiceworks.com/tech/big-data/articles/what-is-support-vector-machine/#:~:text=A%20support%20vector%20machine%20(SVM)%20is%20a%20machine%20learning%20algorithm,classes%2C%20labels%2C%20or%20outputs.}
